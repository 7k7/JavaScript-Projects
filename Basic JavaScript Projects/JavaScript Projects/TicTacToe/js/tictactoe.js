...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            select.style.backgroundImage = 'url("images/mark-o.png")';
        }
        ...
        if (activePlayer === 'X') {
            ...
            activePlayer = 'O';
            //if activePlayer is 'O' or anything other than 'X'
        } else {
        ...
        if (activePlayer === 'O') {
            ...
            disableClick();
            // This function waits 1 second before the computer places an image and enables click back to user.
...
function checkWinConditions() {
    ...
    // 9 squares are selected the code executes.
        ...
        // This f() plays the tie game sound.
...
function audio(audioURL) {
    // We create a new audiio object and we pass the path as a parameter.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        // This method clears content from the last loop iterations.
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (x < x2) { x += 10; }
            // This condition adds 10 to the previous end y enpoint.
            if (y < y2) { y += 10; }
